    ...
    if method == "initialize":
        return {
            ...
            "result": {
                ...
                "capabilities": {"tools": {}},
                "serverInfo": {"name": "model-server", "version": "1.0.0"}
            }
        }
                ...
                "tools": [
                    {
                        ...
                        "inputSchema": {
                            "type": "object",
                            "properties": {
                                "type": {"type": "string", "enum": ["cube","sphere","house"], "description": "Shape to generate"},
            ...
            "commands": [
                {
                    ...
                    "description": "Generate a 3D model (cube, sphere, house) and save as OBJ",
                    "params": {
                        "type": {"type": "string", "enum": ["cube","sphere","house"], "required": True},
                        "size": {"type": "number", "default": 1.0},
                        "segments": {"type": "integer", "default": 16},
                        "width": {"type": "number", "default": 2.0},
                        "depth": {"type": "number", "default": 2.0},
                        "height": {"type": "number", "default": 1.5},
                        "roof_height": {"type": "number", "default": 1.0},
                        "output": {"type": "string", "default": "model.obj"}
                    }
                }
            ]
        })
